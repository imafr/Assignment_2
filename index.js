...
const handleChange=()=>{
  const monthInp = document.getElementById("card_month").value;
...
function handleSubmit(e) {
    ...
    // console.log(monthInp>"12")
    // if(monthInp < "1" || monthInp > "12"){
      
    //   nameInp.classList.add('error');
    //   nameInp.parentElement.classList.add("error_message_month");
    // }
